...
class CUTEMI_Usersdrive_Data_Extract extends CUTEMI_XFileSharing_Data_Extract {

	public function __construct() {
		parent::__construct();
		$this->source = 'cutemi-link-source-usersdrive';
...
new CUTEMI_Usersdrive_Data_Extract();
