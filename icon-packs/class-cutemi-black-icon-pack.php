...
class CUTEMI_Black_Icon_Pack extends CUTEMI_Base_Icon_Pack {

	public function __construct() {
		$this->base_url = plugins_url( 'icon-packs/images/black', CUTE_MEDIAINFO_FILE );
		...
		$this->terms_icons = array(
			'cutemi_file_format'        => array(
				'cutemi-file-format-rmvb-vob' => './video-format/vob.svg',
